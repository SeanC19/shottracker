...
function RinkSVG() {
  return (
    ...
    >
      {/* Ice surface */}
      <rect x="0" y="0" width="400" height="200" fill="#e8f4fd" rx="20" />

      {/* Boards */}
      <rect x="2" y="2" width="396" height="196" fill="none" stroke="#aac" strokeWidth="3" rx="18" />

      {/* Center line */}
      <line x1="200" y1="2" x2="200" y2="198" stroke="#e63946" strokeWidth="3" />

      {/* Blue lines */}
      <line x1="133" y1="2" x2="133" y2="198" stroke="#2563eb" strokeWidth="2.5" />
      <line x1="267" y1="2" x2="267" y2="198" stroke="#2563eb" strokeWidth="2.5" />

      {/* Center circle */}
      <circle cx="200" cy="100" r="30" fill="none" stroke="#e63946" strokeWidth="1.5" />
      <circle cx="200" cy="100" r="2" fill="#e63946" />

      {/* Left goal crease */}
      <rect x="2" y="82" width="18" height="36" fill="#bbd4f5" stroke="#2563eb" strokeWidth="1" />
      <rect x="20" y="86" width="15" height="28" fill="none" stroke="#e63946" strokeWidth="1.5" rx="2" />

      {/* Right goal crease */}
      <rect x="380" y="82" width="18" height="36" fill="#bbd4f5" stroke="#2563eb" strokeWidth="1" />
      <rect x="365" y="86" width="15" height="28" fill="none" stroke="#e63946" strokeWidth="1.5" rx="2" />

      {/* Left face-off circles */}
      <circle cx="76" cy="60" r="20" fill="none" stroke="#e63946" strokeWidth="1.5" />
      <circle cx="76" cy="60" r="2" fill="#e63946" />
      <circle cx="76" cy="140" r="20" fill="none" stroke="#e63946" strokeWidth="1.5" />
      <circle cx="76" cy="140" r="2" fill="#e63946" />

      {/* Right face-off circles */}
      <circle cx="324" cy="60" r="20" fill="none" stroke="#e63946" strokeWidth="1.5" />
      <circle cx="324" cy="60" r="2" fill="#e63946" />
      <circle cx="324" cy="140" r="20" fill="none" stroke="#e63946" strokeWidth="1.5" />
      <circle cx="324" cy="140" r="2" fill="#e63946" />

      {/* Neutral zone dots */}
      <circle cx="160" cy="100" r="2.5" fill="#e63946" />
      <circle cx="240" cy="100" r="2.5" fill="#e63946" />
    </svg>
  )
}
